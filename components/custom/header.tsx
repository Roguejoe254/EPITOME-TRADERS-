      ...
      <div className="flex items-center gap-3">
        {!logoSrc || logoError ? (
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-purple-700 via-purple-600 to-fuchsia-500 p-0.5 shadow-sm shadow-purple-500/20">
              <div className="w-full h-full bg-card rounded-[6px] flex items-center justify-center text-purple-600 dark:text-purple-400 font-extrabold text-sm">
                {logoLetter}
              </div>
            </div>
          </div>
