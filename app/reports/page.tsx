...
const ALL_CONTRACT_TYPES = ['ACCU', 'CALL', 'PUT', 'CALLE', 'PUTE'];

function getTradingContractLabels(
...
export default function ReportsPage() {
  ...
  const contractTypeLabels = getTradingContractLabels(localize);
  ...
  const trading = useBaseTrading({
    ...
    contractTypes: ALL_CONTRACT_TYPES,
  });
